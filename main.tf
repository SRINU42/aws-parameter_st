...
variable "param" {
    default = [
        ...
        { name = "roboshop.dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.erobo.online:27017/catalogue", type = "String" },
        { name = "roboshop.dev.payment.cart_host", value = "cart-dev.erobo.online", type = "String" },
        { name = "roboshop.dev.payment.cart_port", value = "8080", type = "String" },
        { name = "roboshop.dev.payment.user_host", value = "user-dev.erobo.online", type = "String" },
